...
#define schedUSE_TIMING_ERROR_DETECTION_EXECUTION_TIME 1
	...
	#define schedSCHEDULER_TASK_STACK_SIZE 128
	...
	#define schedPOLLING_SERVER_PERIOD pdMS_TO_TICKS( 1200 )
	 ...
	 * enabled. */
	#define schedPOLLING_SERVER_DEADLINE pdMS_TO_TICKS( 900 )
	/* Stack size of the Polling Server. */
	#define schedPOLLING_SERVER_STACK_SIZE 512
